...
export const defaultEventsListConfig: EventsListConfig = {
  ...
  description:
    'Display a list of upcoming and past events with customizable layout and features.',
...
export const defaultAnnouncementBannerConfig: AnnouncementBannerConfig = {
  ...
  description:
    "We're excited to announce new features coming to our platform. Stay tuned for updates and improvements.",
  url: '#',
  style: 'primary',
  showIcon: true,
