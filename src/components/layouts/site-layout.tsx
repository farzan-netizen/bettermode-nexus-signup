...
const HeaderDropdownSimple = ({ onMobileMenuToggle }: { onMobileMenuToggle?: () => void }) => (
    <div className="flex max-w-container mx-auto items-center justify-between w-full px-4 sm:pl-[80px] sm:pr-6 lg:pl-[80px] lg:pr-8 py-4 max-sm:py-3 max-sm:px-3">
        {/* Logo & Mobile Menu */}
