...
const OTPInput = ({
  ...
  renderSeparator,
  placeholder,
  containerStyle = 'flex-wrap gap-2',
  inputStyle = cx(
    'w-12 h-12 sm:w-14 sm:h-14 text-center text-base sm:text-lg font-semibold border border-primary rounded-lg bg-primary text-primary',
