        ...
        <div className="overflow-y-auto max-h-[calc(85vh-140px)]">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-16 px-6">
              ...
              <span className="mt-4 text-tertiary font-medium">
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="text-center">
                ...
                {brandData.description && (
                  <p className="text-tertiary mt-3 max-w-2xl mx-auto leading-relaxed">
                    {brandData.description}
                  </p>
                )}
              </div>
                    ...
                    <div className="space-y-3">
                      {brandData.company.employees && (
                        <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                          ...
                          <span className="font-semibold text-primary">
                            {brandData.company.employees} employees
                          </span>
                        </div>
                      )}
                      ...
                      {brandData.company.location && (
                        <div className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                          ...
                          <span className="font-semibold text-primary">
                            {[
                              brandData.company.location.city,
                              brandData.company.location.state,
                              brandData.company.location.country,
                            ]
                              .filter(Boolean)
                              .join(', ')}
                          </span>
                      ...
                      {brandData.company.industries &&
                        brandData.company.industries.length > 0 && (
                          <div className="p-3 bg-secondary rounded-lg">
                            <span className="text-tertiary font-medium block mb-2">
                              Industries
                            </span>
                            <div className="flex flex-wrap gap-2">
                              {brandData.company.industries
                                ...
                                .map((industry, index) => {
                                  ...
                                  const industryData = allIndustries.find(
                                    ind =>
              ...
              {/* Industries Section */}
              {brandData.company?.industries &&
                brandData.company.industries.length > 3 && (
                  <div>
                    <h4 className="text-lg font-semibold text-primary mb-4 flex items-center gap-2">
                      <div className="w-2 h-2 bg-brand-secondary rounded-full"></div>
                      Industry Focus
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {brandData.fonts.slice(0, 4).map((font, index) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-tertiary capitalize px-2 py-1 bg-tertiary rounded">
                              {font.type}
                            </span>
                          </div>
                        ))}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {brandData.images.slice(0, 4).map((image, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="aspect-video bg-secondary rounded-lg overflow-hidden border border-primary"
                            >
                              <img
                                src={imageUrl}
            ...
            <div className="flex flex-col items-center justify-center py-16 px-6">
              ...
              <p className="text-tertiary text-center max-w-sm">
                We couldn't find brand information for this domain. It might be
                a new company or not in our database.
              </p>
            </div>
          )}
        </div>
