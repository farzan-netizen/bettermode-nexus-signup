...
export const Header = ({ items = headerNavItems, isFullWidth, isFloating, className }: HeaderProps) => {
    ...
    return (
        ...
        >
            <div className="flex size-full max-w-container flex-1 items-center pr-3 pl-[80px] md:pl-[80px] md:pr-8">
                <div
                    className={cx(
                        "flex w-full justify-between gap-4",
                        isFloating && "ring-secondary_alt md:rounded-2xl md:bg-primary md:py-3 md:pr-3 md:pl-[80px] md:shadow-xs md:ring-1",
                    )}
                >
