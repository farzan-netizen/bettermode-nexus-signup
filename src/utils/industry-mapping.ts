...
export const industryMappings: IndustryMapping[] = [
  {
    ...
    mapping_type: 'None',
    notes:
      'B2B SaaS is a business model that can apply to many industries, not a specific industry itself. It is a cross-cutting category.',
  },
  {
...
export const mapIndustryToBrandfetch = (
  selectedIndustry: string,
): MappedIndustry[] | null => {
  // First check if it's one of our predefined mappings
  const mapping = industryMappings.find(
    m =>
