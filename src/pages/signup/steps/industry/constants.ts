...
export type IndustriesMap = Partial<Record<IndustryId, IndustryValue>>

export const INDUSTRIES_MAPPING: IndustriesMap = {
...
export const OTHER_INDUSTRIES_MAPPING: IndustriesMap = {
  [IndustryId.ADULT]: {
    id: IndustryId.ADULT,
    name: 'Adult',
  },
