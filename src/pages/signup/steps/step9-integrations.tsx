  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-end items-center gap-6">
        <button
          onClick={onNext}
          className="text-sm text-brand-secondary hover:text-brand-secondary_hover underline decoration-transparent hover:decoration-brand-secondary underline-offset-2 transition-all cursor-pointer hover:cursor-pointer font-medium"
        >
