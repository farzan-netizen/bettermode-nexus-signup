      ...
      <div className="text-left">
        ...
        <div className="text-left flex flex-col gap-3">
          <h2 className="text-2xl font-base text-primary">
            <span className="font-bold">
              Integrate With Your Entire Ecosystem and Tool in Your Stack
            </span>
          </h2>
          <p className="text-sm text-tertiary mb-4 leading-relaxed">
            +20 Pre-built connections for the tools you already use, plus robust
            APIs for custom integrations. Whether native or custom - we've got
            you covered.
          </p>
          <p className="text-sm text-tertiary mb-3 leading-relaxed">
            This approach emphasizes the <strong>flexibility and choice</strong>{' '}
            rather than focusing on limitations or technical complexity -
            perfect for SaaS buyers who want options.
          </p>
        </div>
        ...
        <div className="border-l-2 border-secondary pl-4 mt-6 mb-4">
          ...
          <blockquote className="text-base text-primary mb-4 leading-relaxed italic">
            "Selected for ease of use and comprehensive capabilities. Perfect
            fit for all our requirements."
          </blockquote>
