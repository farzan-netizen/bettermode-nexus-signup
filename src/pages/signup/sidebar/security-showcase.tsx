        ...
        <div className="text-left flex flex-col gap-3">
          <h2 className="text-2xl font-base text-primary">
            <span className="font-bold">
              Built-In Security & Compliance From Day One
            </span>
          </h2>
          <p className="text-sm text-tertiary mb-3 leading-relaxed">
            SOC 2 Type II certified, GDPR compliant, enterprise SSO, data
            residency controls, 99.9% uptime SLA, comprehensive audit logging,
            and advanced user permissions. Security architecture designed for
            regulated industries and Fortune 500 requirements.
          </p>
          <p className="text-sm text-tertiary mb-4 leading-relaxed">
            Industry-leading data protection with privacy-focused design ensures
            your community meets the highest security standards your customers
