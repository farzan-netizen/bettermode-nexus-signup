...
export const PlanRecommendation = ({ formData }: PlanRecommendationProps) => {
  ...
  const renderRecommendationText = () => {
    ...
    const getBenefits = (plan: string): string[] => {
      ...
      return (
        benefits[plan.toLowerCase() as keyof typeof benefits] ||
        benefits.starter
      )
    }
      ...
      <div className="space-y-4">
        ...
        >
          {(() => {
            ...
            const companySize =
              sizeMap[formData.companySize] || formData.companySize
            ...
            <div className="text-xs text-tertiary">
              <p className="leading-relaxed">
                ...
                {(() => {
                  ...
                  const selectedEnterpriseFeatures =
                    formData.enterpriseFeatures.filter(feature =>
                  ...
                  const selectedAdvancedTools = formData.currentTools.filter(
                    tool => advancedTools.includes(tool),
                  )
                  ...
                  if (
                    ...
                    const features = []
                    if (selectedEnterpriseFeatures.includes('saml-sso'))
                      features.push('SAML')
                    if (selectedEnterpriseFeatures.includes('jwt'))
                      features.push('JWT')
                    if (selectedEnterpriseFeatures.includes('uptime-sla'))
                      features.push('SLA')
                    if (selectedEnterpriseFeatures.includes('audit-log'))
                      features.push('audit logs')
                    if (selectedEnterpriseFeatures.includes('data-residency'))
                      features.push('data residency')
                  ...
                  if (
                    ...
                    if (selectedAdvancedTools.length > 0) {
                      const toolNames = selectedAdvancedTools
                        .slice(0, 3)
                        .map(tool => {
