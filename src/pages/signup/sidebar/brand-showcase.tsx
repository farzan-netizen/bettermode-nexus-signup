      ...
      <div className="flex-1">
        ...
        <div className="text-left flex flex-col gap-3 mb-4">
          ...
          <p className="text-sm text-tertiary">
            ...
            community capabilities. Seamless integrations, powerful analytics,
            and proven frameworks that scale efficiently as you grow.
          </p>
          <p className="text-sm text-tertiary mt-2">
            Built for scaling software & tech companies driving measurable
            community ROI through smart implementation.
          </p>
        </div>
      </div>
          ...
          <div className="flex animate-infinite-scroll space-x-3">
            {[
              ...
              .map((logo, index) => (
                <div
                  key={index}
                  className="w-24 h-16 flex items-center justify-center px-3 flex-shrink-0 transition-all"
                >
                  <img
                    src={logo.src}
                    alt={logo.alt}
                    className="h-8 w-auto object-contain logo-filter-dark-only"
                  />
                </div>
              ))}
          </div>
